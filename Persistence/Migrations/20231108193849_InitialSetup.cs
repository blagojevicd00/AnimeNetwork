    ...
    public partial class InitialSetup : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EpisodeRatings", x => new { x.EpisodeId, x.RatingId });
                    table.ForeignKey(
                        name: "FK_EpisodeRatings_Episodes_EpisodeId",
                        column: x => x.EpisodeId,
                        principalTable: "Episodes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EpisodeRatings_Ratings_RatingId",
                        column: x => x.RatingId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EpisodeRatings_RatingId",
                table: "EpisodeRatings",
                column: "RatingId");
